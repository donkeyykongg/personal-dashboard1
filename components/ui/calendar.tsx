...
function Calendar({
  ...
  const defaultComponents = {
    Chevron: ({ orientation, size = 16, disabled, ...props }: ChevronProps) => {
      if (orientation === "left") {
        return <ChevronLeft size={size} strokeWidth={2} {...props} aria-hidden="true" />;
      }
      return <ChevronRight size={size} strokeWidth={2} {...props} aria-hidden="true" />;
    },
  };
